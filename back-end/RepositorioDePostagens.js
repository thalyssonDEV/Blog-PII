...
class RepositorioDePostagens {
    ...
    povoar() {
        ...
        this.incluir(new Postagem_1.Postagem(2, 'Tecnologia e Inovação', 'Vivemos em uma era onde a tecnologia avança a passos largos. ' +
            ...
            'A tecnologia tem o poder de transformar o mundo em que vivemos.', this.gerarDataAleatoria(), 15));
        this.incluir(new Postagem_1.Postagem(3, 'Sustentabilidade Ambiental', 'Preservar o meio ambiente é crucial para o futuro das próximas gerações. ' +
            ...
            'Devemos agir agora para garantir um planeta habitável no futuro.', this.gerarDataAleatoria(), 20));
        this.incluir(new Postagem_1.Postagem(4, 'Saúde e Bem-Estar', 'Manter o bem-estar físico e mental é essencial para uma vida equilibrada. ' +
            ...
            'Não negligencie seu bem-estar, ele é a chave para uma vida plena.', this.gerarDataAleatoria(), 8));
        this.incluir(new Postagem_1.Postagem(5, 'Economia Digital', 'A transformação digital está mudando a maneira como fazemos negócios. ' +
            ...
            'O futuro é digital, e devemos nos preparar para ele.', this.gerarDataAleatoria(), 12));
        this.incluir(new Postagem_1.Postagem(6, 'Impacto das Redes Sociais', 'As redes sociais têm um papel central na comunicação moderna. ' +
            ...
            'É crucial usar essas ferramentas de forma responsável e consciente.', this.gerarDataAleatoria(), 7));
        this.incluir(new Postagem_1.Postagem(7, 'Mobilidade Urbana', 'Soluções de mobilidade inteligente são o futuro das grandes cidades. ' +
            ...
            'Investir em mobilidade sustentável é essencial para um futuro melhor.', this.gerarDataAleatoria(), 9));
        this.incluir(new Postagem_1.Postagem(8, 'Educação Financeira', 'Gerir as finanças pessoais é fundamental para a estabilidade econômica. ' +
            ...
            'Planejamento e controle são as chaves para o sucesso financeiro.', this.gerarDataAleatoria(), 5));
        this.incluir(new Postagem_1.Postagem(9, 'Alimentação Saudável', 'Uma dieta equilibrada é essencial para manter corpo e mente saudáveis. ' +
            ...
            'Invista em uma alimentação rica em nutrientes e pobre em alimentos processados.', this.gerarDataAleatoria(), 11));
        this.incluir(new Postagem_1.Postagem(10, 'Inovações na Saúde', 'A tecnologia está revolucionando o setor de saúde com novos tratamentos. ' +
            ...
            'O futuro da saúde está cada vez mais integrado com a tecnologia.', this.gerarDataAleatoria(), 13));
    }

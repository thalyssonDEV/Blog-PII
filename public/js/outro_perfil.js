document.addEventListener('DOMContentLoaded', () => {
    ...
    if (perfilHeaderContainer) {
        perfilHeaderContainer.addEventListener('click', (e) => {
            // Verifica se o elemento que foi clicado é o botão "Seguir"
            if (e.target && e.target.id === 'btn-seguir') {
        ...
        perfilHeaderContainer.innerHTML = `
            ...
            <div class="p-4">
                <div class="flex justify-between items-start">
                    ...
                    <button id="btn-seguir" class="future-feature border border-slate-300 dark:border-gray-600 font-semibold py-2 px-4 rounded-full">Seguir</button>
                </div>
                <div class="mt-4">
